...
void draw_lua_items_window() {
	...
	for (auto tab : tabs) {
		...
		*/
		...
		ImGui::SetColumnWidth(1, half_w);
		ImGui::PushItemWidth(half_w);
		draw_lua_items(tab_name, "3");
		ImGui::Text("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		ImGui::PopItemWidth();
		ImGui::PushItemWidth(half_w);
		draw_lua_items(tab_name, "2");
		ImGui::Text("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		ImGui::PopItemWidth();
		ImGui::NextColumn();
		ImGui::SetColumnWidth(0, half_w);
		ImGui::PushItemWidth(half_w);
		draw_lua_items(tab_name, "1");
		ImGui::Text("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		ImGui::PopItemWidth();
		ImGui::PushItemWidth(half_w);
		draw_lua_items(tab_name, "0");
		ImGui::PopItemWidth();
		ImGui::Columns(1);
		*/
		/*
		if (container_count > 0) {
			if (container_count > 1) {
				ImGui::Columns(container_count, nullptr, true);
			}
			//ImGui::Separator();
			for (int i = 0; i < container_count; i++) {
				if (i % 1) {
