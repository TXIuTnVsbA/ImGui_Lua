...
void c_config::default() noexcept {
    ...
    GET_INTS_MAP[gui.container_count]["Demo"] = 2;
    ...
    GET_INTS_MAP[gui.container_count]["Config"] = 2;
    ...
    GET_INTS_MAP[gui.container_count]["Lua"] = 2;
    ...
    GET_INTS_MAP[gui.container_count]["Console"] = 2;
}
